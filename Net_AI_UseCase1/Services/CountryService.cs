...
namespace Net_AI_UseCase1.Services
{
    public class CountryService : ICountryService
    {
        ...
        public static IEnumerable<Country> FilterByCountryName(IEnumerable<Country> countries, string countryName)
        {
        ...
        public static IEnumerable<Country> FilterByPopulation(IEnumerable<Country> countries, int population)
        {
        ...
        public static IEnumerable<Country> SortByCountryName(IEnumerable<Country> countries, string order = "ascend")
        {
        ...
        public static IEnumerable<Country> GetFirstNRecords(IEnumerable<Country> countries, int number) 
        {
            return number < 0 ?
                countries :
